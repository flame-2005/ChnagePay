  ...
  return (
    <>
      ...
      >
        ...
        <SwiperSlide
        style={{
          background: 'linear-gradient(to right, rgba(238, 119, 36, 0.5), rgba(216, 54, 58, 0.5), rgba(221, 54, 117, 0.5), rgba(180, 69, 147, 0.5));'
        }}><section class="text body-font mt-10 h-full">
